...
rm -fv bin/xnotdefteri_120926.jar
...
jar cmf MANIFEST.MF bin/xnotdefteri_120926.jar -C obj net -C . src tool compile_run.txt xcopy.sh ControlChanges.* changes.txt
...
echo "Launching: java -jar bin/xnotdefteri_120926.jar"
java -jar bin/xnotdefteri_120926.jar &

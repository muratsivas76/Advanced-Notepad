...
/**
 * Listener responsible for removing lines that contain a specific user-defined string.
 * It scans each line and skips it if the target string is found anywhere within.
 *
 * Licensed under GPL v3.
 */
public class RemoveLinesContainingActionListener implements ActionListener {
  
  private final JTextPane txt;
  private final JLabel statusLabel;
  private final Component parent;
  
  public RemoveLinesContainingActionListener(JTextPane txt, JLabel statusLabel, Component parent) {
    this.txt = txt;
  ...
  /**
   * Filters the text by removing lines that contain the given input string.
   */
  private String processText(String content, String target) throws IOException {
    ...
    while ((line = br.readLine()) != null) {
      ...
      // Orijinal mantık: indexOf >= 0 ise satırı atla (skip)

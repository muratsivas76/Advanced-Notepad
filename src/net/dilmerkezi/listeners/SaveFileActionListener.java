...
public class SaveFileActionListener implements ActionListener {
  ...
  public SaveFileActionListener(JTextPane txt, JLabel statusLabel, 
   JFileChooser jfc, Component parent, Utilities utilities) {
    this.txt = txt;
  ...
  private void saveFile(File file, String text) {
    ...
    try {
      ...
      osw = new OutputStreamWriter(fos, utilities.getCharCode());
      ...
      SwingUtilities.invokeLater(new Runnable() {
          ...
          public void run() {
            JOptionPane.showMessageDialog(parent,
              ...
              "<font color=\"blue\" size=\"5\"> saved successfully!<br><br>Char code: " + utilities.getCharCode() + "</font></body></html>");
            txt.requestFocus();
          }
      });

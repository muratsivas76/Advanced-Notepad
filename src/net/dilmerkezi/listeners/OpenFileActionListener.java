...
public class OpenFileActionListener implements ActionListener {
  ...
  public OpenFileActionListener(JTextPane txt, JLabel statusLabel, 
            ...
            SwingUtilities.invokeLater(new Runnable() {
                ...
                public void run() {
                  try {
                    ...
                    txt.requestFocus();
                    statusLabel.setText("Opened " + f.getName() + " successfully! Charset: " + utilities.getCharCode());
